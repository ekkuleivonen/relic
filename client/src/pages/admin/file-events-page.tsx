...
const EVENT_TYPE_OPTIONS = [
  ...
  "processor.file_info.failed",
  "processor.image_meta.completed",
  "processor.image_meta.failed",
  "processor.html_meta.completed",
  "processor.html_meta.failed",
  "processor.pdf_meta.completed",
  "processor.pdf_meta.failed",
  "processor.parquet_meta.completed",
  "processor.parquet_meta.failed",
  "processor.csv_meta.completed",
  "processor.csv_meta.failed",
  "processor.json_meta.completed",
  "processor.json_meta.failed",
  "processor.audio_meta.completed",
  "processor.audio_meta.failed",
  "processor.video_meta.completed",
  "processor.video_meta.failed",
  "processor.office_doc_meta.completed",
  "processor.office_doc_meta.failed",
  "processor.archive_meta.completed",
  "processor.archive_meta.failed",
  "processor.text_meta.completed",
  "processor.text_meta.failed",
] as const
