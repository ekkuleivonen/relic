...
def empty_text_meta(*, existing_meta: dict[str, Any] | None = None) -> dict[str, Any]:
...
def parse_text(*, content: bytes, existing_meta: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        ...
        return empty_text_meta(existing_meta=existing_meta)
...
def parse(
    ...
    details = _extract_details(text=text, existing_meta=existing_meta)
    return _build_discovery_meta(details=details, existing_meta=existing_meta)


def _extract_details(*, text: str, existing_meta: dict[str, Any] | None) -> dict[str, Any]:
