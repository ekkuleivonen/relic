    ...
    "properties": {
        ...
        "image": {
            ...
            "properties": {
                ...
                "megapixels": {"type": ["number", "null"]},
                "aspect_ratio": {"type": ["string", "null"]},
                "format": {"type": ["string", "null"]},
                "color_mode": {"type": ["string", "null"]},
                "has_alpha": {"type": ["boolean", "null"]},
                "is_animated": {"type": ["boolean", "null"]},
                "is_grayscale": {"type": ["boolean", "null"]},
        ...
        "csv": {
            ...
            "properties": {
                ...
                "has_header": {"type": ["boolean", "null"]},
                "encoding": {"type": ["string", "null"]},
                "line_terminator": {"type": ["string", "null"]},
                "skipped_prefix_rows": {"type": ["integer", "null"]},
                "empty_cells_pct": {"type": ["number", "null"]},
            },
            "required": [
                "row_count",
                "column_count",
