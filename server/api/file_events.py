...
from application.control_plane import file_events_queries
from constants import FILE_EVENT_DEFAULT_LIMIT, FILE_EVENT_MAX_LIMIT
from ports.entities import FileEvent
...
async def list_file_events(
    ...
    """Poll integrator file events with a monotonic seq cursor.

    Non-admin users only receive events for folders they can READ.
    """
    page = file_events_queries.list_file_events(
        uow,
        user=current_user,
        after=after,
        folder_id=folder_id,
