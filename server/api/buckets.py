...
@router.post("/")
async def create_bucket(request: Request, payload: BucketCreate, db: DbSession) -> BucketRead:
    """
...
async def update_bucket(
    bucket_id: uuid.UUID, request: Request, payload: BucketUpdate, db: DbSession
) -> BucketRead:
    """
...
async def delete_bucket(bucket_id: uuid.UUID, request: Request, db: DbSession) -> Response:
    """
    ...
    """
    bucket_service.delete_bucket(db, bucket_id)
...
async def drain_bucket(bucket_id: uuid.UUID, request: Request, db: DbSession) -> Response:
    """
    ...
    """
    bucket_service.drain_bucket(db, bucket_id)
