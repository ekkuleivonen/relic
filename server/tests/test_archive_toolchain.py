"""Tests for processors.kinds.meta_extract.toolchains.archive."""
...
from processors.kinds.meta_extract.toolchains.archive import empty_archive_meta, parse, parse_archive
